...
if __name__ == "__main__":
    ...
    # Load weights from checkpoint (implementation needed)
    ...
    # Note: You'll need to implement or find a TF equivalent for LPIPS
    # percept = LPIPS()
    ...
    def train_step(latent_in, noises, t):
        with tf.GradientTape() as tape:
            ...
            # Calculate losses
            p_loss = tf.reduce_sum(tf.abs(img_gen - imgs))  # Placeholder for LPIPS
